...
var source = (() => {
  ...
  // src/anify-anime/utils/skipData.ts
  ...
  // src/anify-anime/utils/urlGrabber.ts
  ...
  function caesarRot13(t) {
    return t.replace(/[a-zA-Z]/g, function(t2) {
      const res = String.fromCharCode((t2 <= "Z" ? 90 : 122) >= (t2 = t2.charCodeAt(0) + 13) ? t2 : t2 - 26);
      return res;
    });
  }
  function b64decode(t) {
    ...
    for (let h = 0; h < t.length; h++) {
      r = t[h];
      o = (o <<= 6) | ((r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(r)) < 0 ? void 0 : r);
      if (24 === (u += 6)) {
  ...
  var MyCloudE = class extends VideoExtractor {
    constructor() {
      ...
      this.extract = async () => {
        ...
        const mediaInfoResult = await request("https://anithunder.vercel.app/api/mcloud", "POST", { "Content-Type": "application/json" }, JSON.stringify({ url }));
  ...
  // src/anify-anime/utils/variables.ts
  ...
  var AnifyAnimeModule = class extends BaseModule {
    ...
    async search(query, page) {
      ...
      return {
        info: {
          pages: (_a2 = json.lastPage) != null ? _a2 : 1
        },
        results: json.results.map((item) => {
          var _a3, _b, _c, _d, _e, _f, _g, _h;
          return {
            title: (_c = (_b = (_a3 = item.title.english) != null ? _a3 : item.title.romaji) != null ? _b : item.title.native) != null ? _c : "",
    ...
    async info(url) {
      ...
      const data2 = {
        titles: {
          primary: (_c = (_b = (_a2 = json.title.english) != null ? _a2 : json.title.romaji) != null ? _b : json.title.native) != null ? _c : "",
          secondary: (_f = (_e = (_d = json.title.romaji) != null ? _d : json.title.native) != null ? _e : json.title.english) != null ? _f : ""
        },
        altTitles: [],
        description: (_g = json.description) != null ? _g : "No description found.",
        poster: (_i = (_h = json.coverImage) != null ? _h : json.bannerImage) != null ? _i : "",
        banner: (_k = (_j = json.bannerImage) != null ? _j : json.coverImage) != null ? _k : "",
        status: this.parseStatus((_l = json.status) != null ? _l : "NOT_YET_RELEASED" /* NOT_YET_RELEASED */),
        rating: json.averageRating,
        yearReleased: (_m = json.year) != null ? _m : 2024,
        mediaType: 0 /* EPISODES */,
        seasons: json.mappings.map((mapping) => {
    ...
    async media(url) {
      ...
      for (const provider of json) {
        ...
        for (let i = 0; i < episodeChunks.length; i++) {
          pagination.push({
            id: "".concat(id, "-").concat(provider.providerId, "-").concat(i),
            items: episodeChunks[i].map((episode) => {
              var _a2, _b;
              return {
                title: (_a2 = episode.title) != null ? _a2 : "Episode ".concat(episode.number),
                number: episode.number,
                url: "".concat(id, "-").concat(provider.providerId, "-").concat(episode.id, "-").concat(episode.number),
                thumbnail: (_b = episode.img) != null ? _b : void 0
              };
            }),
            title: "".concat(id, "-").concat(provider.providerId, "-").concat(i)
          });
        }
        data2.push({
    ...
    async servers(_url) {
      ...
      const html3 = await request("".concat(AJAX_BASENAME, "/server/list/").concat(episodeId, "?vrf=").concat(getVrf(episodeId)), "GET");
    ...
    async sources(_url) {
      var _a2;
      try {
        let data2 = await request("".concat(AJAX_BASENAME, "/server/").concat(_url, "?vrf=").concat(getVrf(_url)), "GET");
        if (data2.statusCode != 200) {
          await callWebview("".concat(AJAX_BASENAME, "/server/").concat(_url, "?vrf=").concat(getVrf(_url)));
          data2 = await request("".concat(AJAX_BASENAME, "/server/").concat(_url, "?vrf=").concat(getVrf(_url)), "GET");
        }
